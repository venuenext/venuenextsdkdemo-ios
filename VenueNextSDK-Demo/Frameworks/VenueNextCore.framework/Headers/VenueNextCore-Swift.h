...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VenueNextCore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13VenueNextCore11Environment")
...
@interface NSObject (SWIFT_EXTENSION(VenueNextCore))
...
SWIFT_PROTOCOL("_TtP13VenueNextCore26PaymentMethodRepresentable_")
...
SWIFT_PROTOCOL("_TtP13VenueNextCore18PaymentProcessable_")
...
SWIFT_PROTOCOL("_TtP13VenueNextCore14VNCoreThemable_")
...
SWIFT_CLASS("_TtC13VenueNextCore15VNCoreBaseTheme")
...
SWIFT_CLASS("_TtC13VenueNextCore17VNLocationManager")
...
@interface VNLocationManager (SWIFT_EXTENSION(VenueNextCore)) <CLLocationManagerDelegate>
...
SWIFT_PROTOCOL("_TtP13VenueNextCore15VNOrderProtocol_")
...
SWIFT_CLASS("_TtC13VenueNextCore18VNPaymentProcessor")
...
SWIFT_PROTOCOL("_TtP13VenueNextCore16VNWalletThemable_")
...
SWIFT_CLASS("_TtC13VenueNextCore17VNWalletBaseTheme")
...
SWIFT_CLASS("_TtC13VenueNextCore12VNWalletUser")
...
SWIFT_CLASS("_TtC13VenueNextCore9VenueNext")
...
///
- (void)initializeWithSdkKey:(NSString * _Nonnull)sdkKey sdkSecret:(NSString * _Nonnull)sdkSecret jwt:(NSString * _Nonnull)jwt configURL:(NSURL * _Nonnull)configURL forceReset:(BOOL)forceReset completion:(void (^ _Nonnull)(BOOL, NSError * _Nullable))completion;
/// Intialize the SDK (Async).
/// Note: Do not attempt to use SDK unless completion finishes successfully
/// \param sdkKey String
///
...
/// \param completion Completion block
///
- (void)initializeWithSdkKey:(NSString * _Nonnull)sdkKey sdkSecret:(NSString * _Nonnull)sdkSecret jwt:(NSString * _Nonnull)jwt configData:(NSData * _Nonnull)configData forceReset:(BOOL)forceReset completion:(void (^ _Nonnull)(BOOL, NSError * _Nullable))completion;
/// Intialize the SDK (Async).
/// Note: Do not attempt to use SDK unless completion finishes successfully
/// \param sdkKey String
///
...
@interface VenueNext (SWIFT_EXTENSION(VenueNextCore))
