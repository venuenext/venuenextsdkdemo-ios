...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VenueNextWalletService",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


/// The service responsible for managing data relating to Wallet
SWIFT_CLASS("_TtC22VenueNextWalletService15VNWalletService")
@interface VNWalletService : NSObject
