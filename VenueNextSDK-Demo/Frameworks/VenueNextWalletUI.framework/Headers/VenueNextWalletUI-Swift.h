...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VenueNextWalletUI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17VenueNextWalletUI31PresentableNavigationController")
...
@interface UINavigationController (SWIFT_EXTENSION(VenueNextWalletUI))
...
SWIFT_CLASS("_TtC17VenueNextWalletUI8VNWallet")
...
SWIFT_PROTOCOL("_TtP17VenueNextWalletUI16VNWalletDelegate_")
@protocol VNWalletDelegate
...
SWIFT_CLASS("_TtC17VenueNextWalletUI18VNWalletNavigation")
