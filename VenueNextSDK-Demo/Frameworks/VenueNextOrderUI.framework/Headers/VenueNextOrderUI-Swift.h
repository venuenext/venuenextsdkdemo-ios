...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VenueNextOrderUI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16VenueNextOrderUI25BottomSheetViewController")
...
@interface BottomSheetViewController (SWIFT_EXTENSION(VenueNextOrderUI)) <UITableViewDataSource>
...
SWIFT_CLASS("_TtC16VenueNextOrderUI27CheckoutTableViewController")
...
@interface CheckoutTableViewController (SWIFT_EXTENSION(VenueNextOrderUI)) <NSFetchedResultsControllerDelegate>
...
@interface CheckoutTableViewController (SWIFT_EXTENSION(VenueNextOrderUI)) <DismissDelegate>
...
@interface CheckoutTableViewController (SWIFT_EXTENSION(VenueNextOrderUI)) <RoundedTextFieldViewDelegate>
...
@interface CheckoutTableViewController (SWIFT_EXTENSION(VenueNextOrderUI)) <PageViewTrackable>
...
SWIFT_CLASS("_TtC16VenueNextOrderUI14ExperienceCard")
...
SWIFT_CLASS("_TtC16VenueNextOrderUI25ExperiencesViewController")
...
@interface ExperiencesViewController (SWIFT_EXTENSION(VenueNextOrderUI)) <UITableViewDataSource, UITableViewDelegate>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC16VenueNextOrderUI21LineItemTableViewCell")
...
SWIFT_CLASS("_TtC16VenueNextOrderUI25MarketplaceViewController")
...
SWIFT_CLASS("_TtC16VenueNextOrderUI22MetadataViewController")
...
@interface MetadataViewController (SWIFT_EXTENSION(VenueNextOrderUI)) <UIPageViewControllerDataSource, UIPageViewControllerDelegate>
...
SWIFT_CLASS("_TtC16VenueNextOrderUI31PresentableNavigationController")
...
SWIFT_CLASS("_TtC16VenueNextOrderUI31RichCheckoutTableViewController")
...
SWIFT_CLASS("_TtC16VenueNextOrderUI18StandTableViewCell")
...
SWIFT_CLASS("_TtC16VenueNextOrderUI9TimerCard")
...
@interface UINavigationController (SWIFT_EXTENSION(VenueNextOrderUI))
@property (nonatomic, readonly) UIStatusBarStyle preferredStatusBarStyle;
@end


@interface UINavigationController (SWIFT_EXTENSION(VenueNextOrderUI))
- (void)pushVNMenuFor:(NSString * _Nonnull)menuUUID eventUUID:(NSString * _Nullable)eventUUID productType:(enum ProductType)productType animated:(BOOL)animated;
...
SWIFT_CLASS("_TtC16VenueNextOrderUI7VNOrder")
...
@interface VNOrder (SWIFT_EXTENSION(VenueNextOrderUI)) <VNOrderProtocol>
...
@interface VNOrder (SWIFT_EXTENSION(VenueNextOrderUI))
- (void)resetWithCompletion:(void (^ _Nonnull)(BOOL, NSError * _Nullable))completion;
@end


SWIFT_CLASS("_TtC16VenueNextOrderUI17VNOrderNavigation")
...
+ (UINavigationController * _Nonnull)receiptNavigationControllerWithExperienceItemUUID:(NSString * _Nonnull)experienceItemUUID dismissDelegate:(id <DismissDelegate> _Nullable)dismissDelegate SWIFT_WARN_UNUSED_RESULT;
...
+ (UINavigationController * _Nonnull)menuNavigationControllerWithMenuUUID:(NSString * _Nonnull)menuUUID eventUUID:(NSString * _Nullable)eventUUID productType:(enum ProductType)productType dismissDelegate:(id <DismissDelegate> _Nullable)dismissDelegate SWIFT_WARN_UNUSED_RESULT;
